...
var rapUsSounds = ["Candy shop.mp3", "Gods Plan.mp3","Lose Yourself.mp3","Moonlight.mp3","Munch.mp3","No idea.mp3"];
var currentSongTitle = rapUsSounds[Math.floor(Math.random() * rapUsSounds.length)].replace(".mp3", "");
var currentLife = 5;
var penduArray = [];
